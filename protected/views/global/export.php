<?php if ($model->view == 'form') { ?>
	...
	<?php echo CHtml::form('', 'post', ['id' => 'Export']); ?>
	<?php if ($model->selectedObjects) { ?>
		<div style="float: left; width: 250px">
			<?php if ($model->objects) { ?>
				<?php echo CHtml::dropDownList('Export[objects][]', $model->selectedObjects, $model->objects, [
					'size' => 20,
					'multiple' => true,
					'style' => 'width: 100%'
				]); ?>
	...
	<?php } ?>
	<div style="<?php if ($model->selectedObjects) {
		...
		<div id="exporterType">
			<fieldset>
				...
				<?php echo CHtml::radioButtonList('Export[exporter]', $firstExporter, $model->exporters, ['separator' => ' &nbsp; ']); ?>
			</fieldset>
		</div>
...
<?php }
	...
	echo CHtml::tag('textarea', [
		'style' => 'height: 500px',
		'wrap'  => 'off'
	], htmlspecialchars($model->result, ENT_QUOTES));
	?>
