...
<table class="form">
	...
	<tr>
		<td>
			...
			<?php $radio_options = explode('|', CHtml::activeRadioButtonList($column, 'attribute', [
		...
		<td colspan="2">
			...
			<!---
				<?php echo CHtml::activeRadioButton($column, 'attribute', [
				'value' => '',
				'id'    => CHtml::$idPrefix.'Column_attribute_'
			]); ?>
				<?php echo CHtml::label(Yii::t('core', 'noAttribute'), 'Column_attribute_', ['style' => 'font-style: italic']); ?>
				--->
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<!---
				<?php echo CHtml::activeRadioButton($column, 'attribute', [
				'value' => 'unsigned',
				'id'    => CHtml::$idPrefix.'Column_attribute_unsigned'
			]); ?>
		...
		<td>
			...
			<!---
				<?php echo CHtml::activeRadioButton($column, 'attribute', [
				'value' => 'unsigned zerofill',
				'id'    => CHtml::$idPrefix.'Column_attribute_unsignedzerofill'
			]); ?>
	...
	<tr>
		...
		<td colspan="2">
			...
			<!---
				...
				'id'    => CHtml::$idPrefix.'Column_attribute_on_update_current_timestamp'
			]); ?>
	...
	<?php if ($column->isNewRecord) { ?>
		<tr id="<?php echo CHtml::$idPrefix; ?>settingSize">
			...
			<td>
				...
				<?php echo CHtml::label(Yii::t('core', 'primaryKey'), 'createIndexPrimary', ['disabled' => $table->getHasPrimaryKey()]); ?>
			</td>
			<td>
