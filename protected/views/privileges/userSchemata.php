<div id="dropSchemaPrivilegesDialog" title="<?php echo Yii::t('core', 'dropSchemaSpecificPrivileges'); ?>"
	 style="display: none">
			...
			<tr id="schemata_<?php echo $schema->Db; ?>">
				...
				<td>
					<a href="javascript:void(0)"
					   onclick="privilegesUserSchemata.editSchemaPrivilege('<?php echo $schema->Db; ?>')" class="icon">
						<?php echo Html::icon('edit', 16, false, 'core.edit'); ?>
					</a>
				</td>
				<td>
					<a href="javascript:void(0)"
					   onclick="privilegesUserSchemata.dropSchemaPrivilege('<?php echo $schema->Db; ?>')" class="icon">
