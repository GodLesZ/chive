<div id="languageDialog" title="<?php echo Yii::t('core', 'chooseLanguage'); ?>">
			...
			<?php if (count($languages) > 0) { ?>
				...
				<?php foreach ($languages as $language) { ?>
					<a href="<?php echo $language['url']; ?>" class="icon" style="display: block; margin-bottom: 3px">
						<img class="icon icon16" src="<?php echo BASEURL.'/'.$language['icon']; ?>"
							 alt="<?php echo $language['label']; ?>" />
	...
	<a href="https://translations.launchpad.net/chive" style="float:right; margin-top: 20px;">Help translating this
																							  project...</a>
</div>
		...
		<tr>
			...
			<td style="width: 150px; vertical-align: top">
				<a href="<?php echo $theme['url']; ?>" class="icon">
					<img class="icon icon16" src="<?php echo BASEURL.'/'.$theme['icon']; ?>"
						 alt="<?php echo $theme['label']; ?>" />
...
<div id="login">
	...
	<?php if ($validBrowser) { ?>
		...
		<div id="login-form">
			<?php echo CHtml::form(); ?>
			<?php echo CHtml::activeHiddenField($form, "redirectUrl", [
				"name" => "redirectUrl",
				"id"   => "redirectUrl"
			]); ?>
			<div class="formItems non-floated" style="text-align: left;">
				<div class="item row1">
					...
					<div class="right">
						<?php echo CHtml::activeTextField($form, 'host', [
							'class' => 'text',
							'name'  => 'host'
						]); ?>
					</div>
				...
				<div class="item row2">
					...
					<div class="right">
						<?php echo CHtml::activeTextField($form, 'port', [
							'class' => 'text',
							'name'  => 'port'
						]); ?>
					</div>
			...
			<div class="buttons">
				...
				<?php echo CHtml::submitButton(Yii::t('core', 'login'), ["style" => "width: 0px; height: 0px; opacity: 0"]); ?>
			</div>
		...
		<div id="login-form">
			...
			<div style="margin-top: 10px">
				<a href="http://www.firefox.com">
					<img src="<?php echo BASEURL; ?>/images/browsers/firefox.jpg" alt="Mozilla Firefox"
						 title="Mozilla Firefox" />
				</a>
				<a href="http://www.google.com/chrome">
					<img src="<?php echo BASEURL; ?>/images/browsers/chrome.jpg" alt="Google Chrome"
						 title="Google Chrome" />
				</a>
				...
				<a href="http://www.microsoft.com/windows/Internet-explorer/default.aspx">
					<img src="<?php echo BASEURL; ?>/images/browsers/internetexplorer.jpg"
						 alt="Microsoft Internet Explorer" title="Microsoft Internet Explorer" />
				</a>
			</div>
		</div>
	<?php } ?>
