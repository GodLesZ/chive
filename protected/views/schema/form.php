...
<?php if (!$schema->isNewRecord && $isSubmitted) { ?>
	<script type="text/javascript">
		...
		Notification.add('success', '<?php echo Yii::t('core', 'successEditSchema', ['{schema}' => $schema->SCHEMA_NAME]); ?>', null, <?php echo CJSON::encode($sql); ?>);
	</script>
<?php } ?>
...
<table class="form" style="float: left; margin-right: 20px">
	...
	<tr>
		...
		<td colspan="2">
			<?php echo CHtml::activeTextField($schema, 'SCHEMA_NAME', ($schema->isNewRecord ? [] : ['disabled' => true])); ?>
		</td>
	</tr>
	<tr>
		<td>
