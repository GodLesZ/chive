...
<table class="form">
	...
	<tr>
		...
		<td colspan="2">
			<?php echo CHtml::activeTextField($index, 'INDEX_NAME', ($index->getType() == 'PRIMARY' && !$index->getIsNewRecord() ? ['readonly' => true] : '')); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td colspan="2">
			<?php echo CHtml::activeDropDownList($index, 'type', $indexTypes, ($index->getIsNewRecord() ? [] : ['disabled' => true])); ?>
		</td>
	</tr>
	<tr>
		<td>
			...
			<table class="formList" id="<?php echo CHtml::$idPrefix; ?>columns">
				...
				<?php foreach ($index->columns AS $column) { ?>
					<tr>
						...
						<td>
							<?php echo CHtml::textField('keyLengths['.$column->COLUMN_NAME.']', $column->SUB_PART, ['class' => 'indexSize']); ?>
						</td>
						<td>
						...
						<td>
							<a href="javascript:void(0)"
							   onclick="indexForm.removeColumn('<?php echo CHtml::$idPrefix; ?>', this)" class="icon">
