...
<?php echo CHtml::form(Yii::app()->createUrl('row/update'), 'POST', ['id' => 'form_'.$id]); ?>
	...
	<div style="padding: 2px 10px;">
		...
		<?php echo CHtml::hiddenField('isNull', 0, ['id' => 'isNull']); ?>

		<?php $this->widget('InputField', [
			'row'         => $row,
			'column'      => $column,
			'htmlOptions' => [
				'id'           => 'input_'.$id,
		...
		<div class="buttonContainer" style="white-space: nowrap">
			...
			<?php if ($column->allowNull) { ?>
				...
				<a href="javascript:void(0);" onclick="$('#isNull').val(1); $('#form_<?php echo $id; ?>').submit();"
				   class="icon button">
